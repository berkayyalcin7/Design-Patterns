using WebApp.Command.DbContexts;
...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!userManager.Users.Any())
    {
        ...
        {
            identityDbContext.Products.Add(new Product { Name = $"Phone {x}", Price = x * Random.Shared.Next(1, 150), Stock = x + Random.Shared.Next(1, 240) });
        });
